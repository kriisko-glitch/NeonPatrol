...
void ATP_ThirdPersonCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	{
		UE_LOG(LogTP_ThirdPerson, Error, TEXT("'%s' Failed to find an Enhanced Input component!"), *GetNameSafe(this));
	}
}
...
void ATP_ThirdPersonCharacter::DoJumpStart() { Jump(); }
void ATP_ThirdPersonCharacter::DoJumpEnd() { StopJumping(); }
